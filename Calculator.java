...
public class Calculator {
   ...
   // declare methods -- to implement behavior/actions
   // declare a method called add -- each method describes one behavior/ task the objects know to perform
   ...
   // declare a method called subtract -- each method describes one behavior/ task the objects know to perform
